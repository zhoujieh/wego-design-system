(function registerWegoPrototypeDb() {
  ...
  var dynamics = [
    ...
    /* 多图九宫格演示数据：覆盖 2 图（2 列）/ 4 图（2×2）/ 9 图（3×3 满格）三种列数适配 */
    { dynamic_id: 'dyn-16', publisher_id: 'pub-02', published_at: '刚刚', published_order: 18, content_type: 'product', category_id: 'clothing', text_content: '两图动态：左右并排（2 列适配）', media_list: [media('m-16a', 'image', assetImage('prod-clothing-001')), media('m-16b', 'image', assetImage('prod-clothing-002'))], related_product_ids: ['prod-clothing-001'] },
    { dynamic_id: 'dyn-17', publisher_id: 'pub-03', published_at: '刚刚', published_order: 17, content_type: 'product', category_id: 'clothing', text_content: '四图动态：2×2 方阵（2 列适配）', media_list: [media('m-17a', 'image', assetImage('prod-clothing-001')), media('m-17b', 'image', assetImage('prod-clothing-002')), media('m-17c', 'image', assetImage('prod-clothing-003')), media('m-17d', 'image', assetImage('prod-clothing-004'))], related_product_ids: ['prod-clothing-001'] },
    { dynamic_id: 'dyn-18', publisher_id: 'pub-04', published_at: '刚刚', published_order: 16, content_type: 'product', category_id: 'clothing', text_content: '九图动态：3×3 满格九宫格（3 列适配）', media_list: [media('m-18a', 'image', assetImage('prod-clothing-001')), media('m-18b', 'image', assetImage('prod-clothing-002')), media('m-18c', 'image', assetImage('prod-clothing-003')), media('m-18d', 'image', assetImage('prod-clothing-004')), media('m-18e', 'image', assetImage('prod-clothing-005')), media('m-18f', 'image', assetImage('prod-clothing-006')), media('m-18g', 'image', assetImage('prod-clothing-007')), media('m-18h', 'image', assetImage('prod-clothing-008')), media('m-18i', 'image', assetImage('prod-clothing-009'))], related_product_ids: ['prod-clothing-001'] }
  ];
