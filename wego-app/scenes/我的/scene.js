/* wego-design-contract:
{
  ...
  "prompt_contract": {
    ...
    "token_bindings": [
      ...
      { "selector": ".my-page__scroll", "content_role": "页面顶部安全区", "css_property": "padding-top", "token": "var(--safe-area-top)" },
      ...
      { "selector": ".my-page__scroll", "content_role": "页面底部留白", "css_property": "padding-bottom", "token": "var(--spacer-16)" },
