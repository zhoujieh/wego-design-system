(function () {
  ...
  var template = ''
    ...
    +         '<button type="button" class="navbar__action business-home__nav-action" data-action="receive-code" aria-label="收款码"><span class="navbar__action-icon business-home__nav-action-icon"><img src="./scenes/infras/工作台/assets/nav-receive-code.svg" alt="" /></span><span class="navbar__action-label">收款码</span></button>'
    +         '<button type="button" class="navbar__action business-home__nav-action" data-action="scan" aria-label="扫一扫"><span class="navbar__action-icon business-home__nav-action-icon"><img src="./scenes/infras/工作台/assets/nav-scan.svg" alt="" /></span><span class="navbar__action-label">扫一扫</span></button>'
    +         '<button type="button" class="navbar__action business-home__nav-action" data-action="trade-settings" aria-label="交易设置"><span class="navbar__action-icon business-home__nav-action-icon"><img src="./scenes/infras/工作台/assets/nav-settings.svg" alt="" /></span><span class="navbar__action-label">交易设置</span></button>'
    +       '</div>'
    +     '</div>'
    +   '</div>'
    +   '<div class="business-home__body">'
    +     '<section class="business-home__hero" aria-label="今日经营数据">'
    +       '<img class="business-home__hero-deco business-home__hero-deco--one" src="./scenes/infras/工作台/assets/bg-ellipse-1523.svg" alt="" aria-hidden="true" />'
    +       '<img class="business-home__hero-deco business-home__hero-deco--two" src="./scenes/infras/工作台/assets/bg-ellipse-1524.svg" alt="" aria-hidden="true" />'
    +       '<img class="business-home__hero-deco business-home__hero-deco--three" src="./scenes/infras/工作台/assets/bg-ellipse-1525.svg" alt="" aria-hidden="true" />'
    +       '<img class="business-home__hero-deco business-home__hero-deco--four" src="./scenes/infras/工作台/assets/bg-ellipse-1526.svg" alt="" aria-hidden="true" />'
