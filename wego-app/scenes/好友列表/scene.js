/* wego-design-contract: {
  ...
  "prompt_contract": {
    ...
    "token_bindings": [
      ...
      {
        "selector": ".friend-list__navbar",
        "content_role": "导航栏背景",
        "css_property": "background",
        "token": "var(--bg-page)"
      },
      {
        "selector": ".friend-list__search",
        "content_role": "搜索区背景",
        "css_property": "background",
        "token": "var(--bg-page)"
      },
      {
        "selector": ".friend-list__search",
        "content_role": "搜索区纵向留白",
        "css_property": "padding-block",
        "token": "var(--spacer-8)"
      },
      {
        "selector": ".friend-list__search",
        "content_role": "搜索区横向留白",
        "css_property": "padding-inline",
        "token": "var(--spacer-16)"
      },
      {
        "selector": ".friend-list__scroll",
        "content_role": "列表底部留白",
        "css_property": "padding-bottom",
        "token": "var(--spacer-24)"
      },
      {
        "selector": ".friend-list__group-title",
        "content_role": "分组标题顶部留白",
        "css_property": "padding-top",
        "token": "var(--spacer-16)"
      },
      {
        "selector": ".friend-list__group-title",
        "content_role": "分组标题横向留白",
        "css_property": "padding-inline",
        "token": "var(--spacer-16)"
      },
      {
        "selector": ".friend-list__group-title",
        "content_role": "分组标题底部留白",
        "css_property": "padding-bottom",
        "token": "var(--spacer-8)"
      },
      {
      ...
      {
        "selector": ".friend-list__meta",
        "content_role": "好友元信息间距",
        "css_property": "gap",
        "token": "var(--spacer-4)"
      },
      {
        "selector": ".friend-list__meta",
        "content_role": "好友元信息上间距",
        "css_property": "margin-top",
        "token": "var(--spacer-4)"
      },
      {
        "selector": ".friend-list__meta-text",
        "content_role": "好友元信息字号",
        "css_property": "font-size",
        "token": "var(--body-sm-font-size)"
      },
      {
        "selector": ".friend-list__meta-text",
        "content_role": "好友元信息行高",
        "css_property": "line-height",
        "token": "var(--body-sm-line-height)"
      },
      {
        "selector": ".friend-list__meta-text",
        "content_role": "好友元信息颜色",
        "css_property": "color",
        "token": "var(--text-tertiary)"
      },
      {
        "selector": ".friend-list__new-count",
        "content_role": "上新数量颜色",
        "css_property": "color",
        "token": "var(--text-brand)"
      },
      {
        "selector": ".friend-list__index",
        "content_role": "索引区右侧安全间距",
        "css_property": "right",
        "token": "var(--spacer-2)"
      },
      {
        "selector": ".friend-list__index",
        "content_role": "索引项紧凑间距",
        "css_property": "gap",
        "token": "var(--spacer-2)"
      },
      {
      ...
      {
        "selector": ".friend-list__index-item",
        "content_role": "索引项字号",
        "css_property": "font-size",
      ...
      {
        "selector": ".friend-list__index-item",
        "content_role": "索引项最小宽高",
        "css_property": "min-width",
        "token": "var(--spacer-16)"
      },
      {
        "selector": ".friend-list__index-item:active",
        "content_role": "索引项按压颜色",
        "css_property": "color",
        "token": "var(--text-brand)"
      },
      {
        "selector": ".friend-list__index-item.is-pressed",
        "content_role": "索引项按压颜色",
        "css_property": "color",
        "token": "var(--text-brand)"
      },
      {
        "selector": ".friend-list__index-item--active",
        "content_role": "索引项激活颜色",
        "css_property": "color",
        "token": "var(--text-brand)"
      },
      {
        "selector": ".friend-list__index-item--active",
        "content_role": "索引项激活字重",
        "css_property": "font-weight",
        "token": "var(--font-weight-medium)"
      },
      {
        "selector": ".friend-list__empty",
        "content_role": "空状态留白",
      ...
      {
        "selector": ".friend-list__empty-icon",
        "content_role": "空状态图标字号",
        "css_property": "font-size",
        "token": "var(--size-48)"
      },
      {
        "selector": ".friend-list__empty-icon",
        "content_role": "空状态图标行高",
        "css_property": "line-height",
        "token": "var(--body-xs-line-height)"
      },
      {
        "selector": ".friend-list__empty-icon",
        "content_role": "空状态图标颜色",
        "css_property": "color",
        "token": "var(--text-disabled)"
      },
      {
        "selector": ".friend-list__empty-text",
        "content_role": "空状态文字颜色",
        "css_property": "color",
        "token": "var(--text-tertiary)"
      },
      {
        "selector": ".friend-list__empty-text",
        "content_role": "空状态文字字号",
        "css_property": "font-size",
        "token": "var(--body-md-font-size)"
      },
      {
        "selector": ".friend-list__empty-text",
        "content_role": "空状态文字行高",
        "css_property": "line-height",
        "token": "var(--body-md-line-height)"
      },
      {
        "selector": ".friend-add-form__body",
        "content_role": "全屏模态表单容器背景",
        "css_property": "background",
        "token": "var(--bg-page)"
      },
      {
        "selector": ".friend-add-form__body",
        "content_role": "全屏模态表单容器文字",
        "css_property": "color",
        "token": "var(--text-default)"
      },
      {
        "selector": ".friend-add-form__body",
        "content_role": "全屏模态表单容器字体",
        "css_property": "font-family",
        "token": "var(--body-md-font-family)"
      }
    ],
    "component_bindings": [
      {
        "binding_id": "friend-navbar",
        "slug": "navbar",
        "reason": "承载好友页面左对齐大标题、新建好友与排序切换入口",
        "variant_dimensions": {
          "leftControl": "none",
          "titleAlignment": "left-wide",
          "actions": "icon",
      ...
      {
        "binding_id": "friend-search",
        "slug": "search",
        "reason": "提供商家名称搜索入口，白底搜索框放在灰底页面上，输入后显示清除并支持继续输入",
        "variant_dimensions": {
          "size": "md",
          "surface": "white",
          "mode": "text",
      ...
      {
        "binding_id": "friend-add-form-modal",
        "slug": "modal",
        "reason": "新建商家好友全屏模态容器，fullscreen 变体，通过 ctx.openFullScreenModal 消费；内含 navbar + 表单 body，蒙层与动画由组件自身承担；modal__body 无默认 padding，本场景无底部 action/cancel，body 必须加 modal__body--safe-bottom 预留 40px + safe-area-bottom；表单走 entity-form 范式（M0 通栏白底、form-group__content 不加 --card）",
        "variant_dimensions": {
          "variant": "fullscreen",
          "title": "default",
          "action": "none",
      ...
      {
        "binding_id": "friend-add-form-fields",
        "slug": "form",
        "reason": "新建商家好友表单字段组，复用 entity-form 范式的 form-group / form-body 结构，覆盖头像上传、商家名称输入、手机号前缀、分组选择和备注长文本；必填字段通过 form-body__label--required + form-body__required 使用红色星号",
        "variant_dimensions": {
          "layout": "vertical",
          "alignment": "default",
          "inputType": "custom",
      ...
      {
        "binding_id": "friend-group-sheet",
        "slug": "actionsheet",
        "reason": "选择好友分组底部面板，通过 ctx.openSheet 消费；渲染完整 .actionsheet 根节点 + .actionsheet__panel 及子内容，关闭行为覆盖 cancel 与 mask",
        "variant_dimensions": {
          "mode": "select",
          "header": "text",
          "item": "text",
      ...
      {
        "binding_id": "friend-source-sheet",
        "slug": "actionsheet",
        "reason": "选择好友来源渠道底部面板，通过 ctx.openSheet 消费；渲染完整 .actionsheet 根节点 + .actionsheet__panel 及子内容，关闭行为覆盖 cancel 与 mask",
        "variant_dimensions": {
          "mode": "select",
          "header": "text",
          "item": "text",
    ...
    "layout_contract": {
      ...
      "selection_reason": "好友列表以连续浏览为主；页面根与主滚动区通栏，navbar 与搜索作为始终可见的通栏导航区域，搜索控件由语义搜索组承担 16px 内边距，连续好友行由组件自身承担内部留白，右侧索引处于页面 navigation 层。",
      "mutable_regions": [
        ".friend-list__scroll",
        ".friend-list__group",
        ".friend-list__index"
      ...
      "page_layers": [
        {
          "region_id": "friend-navbar",
          "selector": ".friend-list__navbar",
          "scope": "page-local",
          "role": "navigation"
        },
        {
          "region_id": "friend-search",
          "selector": ".friend-list__search",
          "scope": "page-local",
          "role": "navigation"
        },
        {
          "region_id": "friend-list-content",
          "selector": ".friend-list__scroll",
          "scope": "page-local",
          "role": "content"
        },
        {
          "region_id": "friend-index",
          "selector": ".friend-list__index",
          "scope": "page-local",
          "role": "navigation"
        }
      ...
      "scroll_architecture": {
        "viewport_selector": ".friend-list",
        "primary_scroll_selector": ".friend-list__scroll",
      ...
      "layout_groups": [
        {
          "group_id": "friend-navbar-group",
          "selector": ".friend-list__navbar",
          "content_role": "页面导航通栏 surface",
          "inline_inset_token": "var(--layout-page-margin-m0)",
          "spacing_owner": "component",
          "gap_token": "var(--spacer-0)"
        },
        {
          "group_id": "friend-search-group",
          "selector": ".friend-list__search",
          "content_role": "好友搜索内容组",
          "inline_inset_token": "var(--spacer-16)",
          "spacing_owner": "scene",
          "gap_token": "var(--spacer-0)"
        },
        {
          "group_id": "friend-list-group",
          "selector": ".friend-list__scroll",
          "content_role": "连续好友内容组，行内留白由 cell 组件承担",
          "inline_inset_token": "var(--layout-page-margin-m0)",
          "spacing_owner": "component",
          "gap_token": "var(--spacer-0)"
        }
    ...
    "interaction_contract": [
      {
        "dom_id": "sort-toggle",
        "target": "state:sort-by-letter"
      },
      {
        "dom_id": "friend-search-input",
        "target": "state:searching"
      },
      {
        "dom_id": "friend-search-clear",
        "target": "state:list-ready"
      },
      {
        "dom_id": "add-friend-entry",
        "target": "overlay:full-screen-modal"
      },
      {
        "dom_id": "select-friend-group",
        "target": "overlay:sheet"
      },
      {
        "dom_id": "select-friend-source",
        "target": "overlay:sheet"
      }
    ],
    "state_contract": [
      {
        ...
        "initial": true,
        "trigger": "进入好友主 tab",
        "visible_result": "默认字母排序展示好友列表，右侧悬浮字母索引",
        "fallback": "保留当前可浏览的好友列表",
        "persistence": "memory"
      },
      {
        "state_id": "sort-by-letter",
        "initial": false,
        "trigger": "点击导航栏右侧排序切换（目标为字母）",
        "visible_result": "按拼音首字母 A-Z + # 分组，右侧索引显示字母",
        "fallback": "保持当前排序",
        "persistence": "memory"
      },
      {
        "state_id": "sort-by-group",
        "initial": false,
        "trigger": "点击导航栏右侧排序切换（目标为分组）",
        "visible_result": "按自定义分组聚合，组内按拼音排序，右侧索引显示分组名",
        "fallback": "保持当前排序",
        "persistence": "memory"
      },
      {
        ...
        "initial": false,
        "trigger": "在搜索框输入关键词",
        "visible_result": "实时过滤匹配商家名称、商家类型或地区的好友，隐藏分组标题与索引",
        "fallback": "清空关键词回到列表",
        "persistence": "memory"
      },
      {
        "state_id": "search-empty",
        "initial": false,
        "trigger": "搜索无匹配结果",
        "visible_result": "展示搜索无结果空状态",
        "fallback": "清空关键词回到列表",
        "persistence": "memory"
      },
      {
        "state_id": "add-form",
        "initial": false,
        "trigger": "点击导航栏右侧新建商家入口",
        "visible_result": "打开添加商家全屏表单",
        "fallback": "取消关闭表单",
        "persistence": "memory"
      },
      {
        "state_id": "submit-success",
        "initial": false,
        "trigger": "提交添加商家表单",
        "visible_result": "关闭表单，显示成功 toast，列表新增商家好友",
        "fallback": "回到列表",
        "persistence": "memory"
      }
    ]
