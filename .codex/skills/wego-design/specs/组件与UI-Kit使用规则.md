...
- 当前稳定组件包括：按钮、卡片、头像、标签、底部导航、输入框、计数器、角标、列表单元格、复选框、表单容器、图片、链接、单选、选项卡、开关、导航栏、提示、对话框、底部操作表单、底部模态框。
...
<!-- source-fingerprint: fa2bd76aa877e2931bdcb52d25fe6cfa589e09e046b1b0a0370f17baa9b48124 -->
