...
if (decision) {
  ...
  for (const binding of prompt.token_bindings || []) {
    if (!binding.content_role || !binding.css_property || !binding.token || !binding.rule_ref) add('scene.token_binding', '每个 token_bindings 项必须包含 content_role、css_property、token、rule_ref', decisions);
