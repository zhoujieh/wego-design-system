 ...
 *
 * Usage:
 *   node scripts/reset-wego-app-baseline.mjs            # 实际重置（删场景、重建路由）
 *   node scripts/reset-wego-app-baseline.mjs --check    # 校验场景和路由均已回到空白基线
...
function checkBaseline() {
  ...
  console.log('[reset-baseline] 已是空白基线，场景和路由状态一致');
}
